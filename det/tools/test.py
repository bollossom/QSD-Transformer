...
"""
1. /home/ligq/qxr/bsnn/Spike-Driven-Transformer-V2/detection2/mmdet/visualization/local_visualizer.py定义了DetLocalVisualizer的hook，数据类型为RGBA，如果想改回来就需要搜索所有mask_draw有关的方法里的alphas令其=self.alpha
